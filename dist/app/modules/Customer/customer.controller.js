...
const getAllCustomer = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const customers = yield customer_service_1.CustomerService.getAllCustomerIntoDB();
    (0, sendResponse_1.default)(res, {
        success: true,
...
const getCustomerById = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const customer = yield customer_service_1.CustomerService.getCustomerByIdIntoDB(id);
    (0, sendResponse_1.default)(res, {
        success: true,
        message: "Customers fetched successfully",
        data: customer
...
const deleteCustomer = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    yield customer_service_1.CustomerService.deleteCustomerIntoDB(id);
    (0, sendResponse_1.default)(res, {
        success: true,
